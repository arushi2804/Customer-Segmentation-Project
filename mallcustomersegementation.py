# -*- coding: utf-8 -*-
"""MallCustomerSegementation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ff2yiEHE4dhhBUC9t85pMjz1hIcR2mYo
"""

# Commented out IPython magic to ensure Python compatibility.
import numpy as np #for Linear Algebra and Mathematical Calculations
import pandas as pd #to make use of files like CSV, for processsing
...
# Scatter Plot for Annual Income vs Spending Score w.r.t Gender
...
X3 = mall_data[['Age' , 'Annual Income (k$)' ,'Spending Score (1-100)']].iloc[: , :].values
inertia = []
for n in range(1 , 11):
    algorithm = (KMeans(n_clusters = n ,init='k-means++', n_init = 10 ,max_iter=300,
                        tol=0.0001,  random_state= 111  , algorithm='elkan') )
...
trace1 = go.Scatter3d(
    ...
    z= mall_data['Annual Income (k$)'],
    mode='markers',
     marker=dict(
        color = mall_data['label3'],
        size= 20,
        line=dict(
            color= mall_data['label3'],
            width= 12
